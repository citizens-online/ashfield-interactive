...
age_map <- tm_shape(full_data_age, name = "Age by LSOA (%)") +
  ...
  tm_shape(select(ward_boundaries, wd19nm), name = "Ward boundaries") +
    tm_borders(col = "gold1", lwd = 2, alpha = 0.5) +
...
### **Disability and digital exclusion.** Disabled people are much less likely to be online than non-disabled people. The map shows claimant numbers for three disability-related benefits (DLA, ESA, PIP).
