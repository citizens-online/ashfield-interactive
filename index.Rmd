...
### **Disability and digital exclusion.** Disabled people are much less likely to be online than non-disabled people. We estimate the disabled population in an area by using claimant numbers for three disability-related benefits (DLA, ESA, PIP). Layers may be turned on and off using the layers tool at the top left.
